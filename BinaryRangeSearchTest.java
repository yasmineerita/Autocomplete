...
public class BinaryRangeSearchTest {
    ...
    public void testSimpleExample() {
        Collection<Term> moreTerms = List.of(
            ...
            new SimpleTerm("me", 0),
            new SimpleTerm("ProNails", 0)
        );
        BinaryRangeSearch brs = new BinaryRangeSearch(moreTerms);
        List<Term> expected = List.of(new SimpleTerm("   ", 0));
        assertEquals(expected, brs.allMatches(""));
    }
    ...
    public void testing(){
        Collection<Term> moreTerms = List.of(
                new SimpleTerm("hello", 3000),
                new SimpleTerm("world", 0),
                new SimpleTerm("welcome", 0),
                new SimpleTerm("to", 0),
                new SimpleTerm("autocomplete", 0),
                new SimpleTerm("me", 0),
                new SimpleTerm("antibacterial", 0),
                new SimpleTerm("hellaa", 100),
                new SimpleTerm("well", 0),
                new SimpleTerm("too", 0),
                new SimpleTerm("hela", 10)
        );
        BinaryRangeSearch brs = new BinaryRangeSearch(moreTerms);
        List<Term> expected = List.of(new SimpleTerm("autocomplete", 0));
        System.out.println(brs.allMatches("he"));
    }
